...
export const endpoints = {
  ...
  outbound: { config: '/outbound/config', call: '/outbound/call', connect: '/outbound/twilio/connect', campaigns: '/outbound/campaigns', campaignPreview: '/outbound/campaigns/preview', campaignStart: (id) => `/outbound/campaigns/${id}/start`, campaignCancel: (id) => `/outbound/campaigns/${id}/cancel` },
  settings: { ai: '/settings/ai' },
  customers: { list: '/customers', find: '/customers/find', one: (id) => `/customers/${id}` },
